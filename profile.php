	...
	<div class="navbar navbar-inverse navbar-fixed-top" style="background-color:black">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color:white"><span class="glyphicon glyphicon-user"></span> <?php echo "Hi, ".$_SESSION["name"]; ?></a>
		...
		<div class="row">
			...
			<div class="col-md-8">	
				...
				<div class="panel panel-info" id="scroll">
					<div class="panel-heading" style='background-color:black'>Products</div>
					...
					<div class="panel-footer" align="center" style = "color:black">&copy; <?php echo date("Y"); ?></div>
					<p align="center" style = "color:black"> Made by Rahul</p>
			</div>
			<div class="col-md-1"></div>
		</div>
		<div class="row">
