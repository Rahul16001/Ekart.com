								...
								<div class="col-md-8">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<h1 align="center" style="font-size:35px; font-weight:bold; font-fmaily:cursive; color:green">Thank You For Shopping With <a href="index.php" style="text-decoration:none"><span style="color:red; font-family: cursive; font-size:35px; padding-top:10px">Ekart.com</span></a></h1>
											<hr/>
